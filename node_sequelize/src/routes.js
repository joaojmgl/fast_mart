...
router.get("/products/get-expiring-products/:company_id",ProductController.getExpiringProducts);
router.delete("/products/decrease-quantity/:code/:company_id",ProductController.deleteQuantity);

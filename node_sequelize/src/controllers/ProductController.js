...
module.exports = {
    ...
    async store(product, quantity, expiryDate, company_id) {
        try {
            const { name, unit_of_measure, purchase_price, sale_price, supplier, code } = product;
    ...
    // Função para a equipe de dados: retorna a data inicial, data final e o company_id para filtragem dos produtos que irão vencer
